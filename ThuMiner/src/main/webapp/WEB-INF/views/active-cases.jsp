            ...
            <div class="row">
              ...
              <div role="tabpanel" class="tab-pane active" id="Overview">
                <div class="col-sm-2 col-md-2 col-sm-offset-1 col-md-offset-1 sidebar">
                  <ul class="nav nav-sidebar">
                    <li><a href="statistics.html">Events over time</a></li>
                    <li class="active"><a href="#active-cases">Active Cases</a></li>
                    ...
                    <li ><a href="#caseutilization">Case Utilization</a></li>
                ...
                <div class="col-md-8">
                      <h2>Overview</h2>
                      <div id="test" style="width: 600px;height:280px;"></div>
                </div>
                <div class="col-md-4">
